        ...
        <div className="row">
          <div className="col-md-12 mt-4">
            ...
            <div className="form-check form-check-inline">
              <input className="form-check-input" type="radio" name="filterRadio" id="allRadio" value="all" checked={filterValue === 'all'} onChange={handleFilterChange} />
              <label className="form-check-label" htmlFor="allRadio">
                All
              </label>
            </div>
            <div className="form-check form-check-inline">
              <input className="form-check-input" type="radio" name="filterRadio" id="homeParkingRadio" value="homeParking" checked={filterValue === 'homeParking'} onChange={handleFilterChange} />
              <label className="form-check-label" htmlFor="homeParkingRadio">
                Home-Parking
              </label>
            </div>
            <div className="form-check form-check-inline">
              <input className="form-check-input" type="radio" name="filterRadio" id="establishmentParkingRadio" value="establishmentParking" checked={filterValue === 'establishmentParking'} onChange={handleFilterChange} />
              <label className="form-check-label" htmlFor="establishmentParkingRadio">
                Establishment Parking
              </label>
            </div>
            <div className="form-check form-check-inline">
              <input className="form-check-input" type="radio" name="filterRadio" id="parkingLotRadio" value="parkingLot" checked={filterValue === 'parkingLot'} onChange={handleFilterChange} />
      ...
      <section className="row mt-4" id="boxContainer">
        <div className="col-md-2 box all homeParking">
          ...
          <button className="btn btn-primary btn-sm" id="detailsButton">
            <Link to="/parking-details" className="details-btn">
              Details
            </Link>
          </button>
        </div>
