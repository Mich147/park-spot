  ...
  return (
    <Col lg={4} className="my-3">
      <Card>
        ...
        <Card.Body>
          <Card.Title className="text-capitalize">Location: {location}</Card.Title>
          <Card.Text className="text-capitalize">Type of Parking: {parkType}</Card.Text>
        </Card.Body>
        <ListGroup className="list-group-flush">
          <ListGroup.Item>Available for: {Array.isArray(carType) ? carType.map((car) => car).join(', ') : carType}</ListGroup.Item>
